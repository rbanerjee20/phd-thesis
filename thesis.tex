...
\begin{figure}[h]
  \begin{center}
    \begin{minipage}[t]{.25\textwidth}
      ...
      \scalebox{0.8}{\lstinputlisting[language=CNC, lastline=12]{code_snippets/intlist.cn.c}}
    \end{minipage}
    %
    %
    ...
    \begin{minipage}[t]{.3\textwidth}
      ...
      \scalebox{0.8}{\lstinputlisting[language=CNC,firstline=13]{code_snippets/intlist.cn.c}}
    \end{minipage}
