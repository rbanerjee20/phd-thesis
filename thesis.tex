...
\chapter{Testing separation-logic specifications}
...
\chapter{Fulminate: Design and Implementation}

Fulminate paper plus whatever comes to mind.

\chapter{Partial specifications}
...
\chapter{A testing-centred workflow for writing specifications}

Code-Specify-Test-Debug-Prove. Start generic, and then move towards our concrete workflow using the CN specification language, Fulminate, Bennet+Darcy, and CN proof.
