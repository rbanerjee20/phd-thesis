...
PS 15/07: Might want to enumerate all possible axes in text, in intro (with subtitles, subsections, etc). Banerjee's hypercube\dots and take the top 15-20 tools you know and try to place them in the hypercube. You could make it a 3D cube if one of the axes can be sort-of squashed onto another. E.g.~2 and 3?!

NK 15/07: Hypercube is useful for understanding the space and the hole I am trying to fill.
