...
This driver creates a singleton linked list with value 2, storing this at the address of the newly-created \texttt{i1}. It then creates a distinct-in-memory linked list of two elements $[3, 4]$ stored at the address of the newly-created \texttt{i2}. Finally, it calls the \texttt{list\_append} function, passing the addresses of \texttt{i1} and \texttt{i2} as arguments, and stores the resulting pointer in \texttt{res}.
